...
const HostEvaluation = () => {
  ...
  if (isMobile) {
    return (
      <Grid width="350px" padding="5%" margin="0px auto -14px -17px">
        <Text bold size="14px" margin="12px 0 0 0">
          받은 굿러너 평가 (총 &nbsp;
        ...
        <Grid display="flex" alignItems="center" margin="8px 0 0 5px">
          <_Box>
            <_Img src="https://ifh.cc/g/9soljs.png" />
            <Text bold size="11px" margin="-4px 0 0 0">
        ...
        <Grid display="flex" alignItems="center" margin="-5px 0 15px 5px">
          <_Box>
            <_Img src="https://ifh.cc/g/9soljs.png" />
            <Text bold size="11px" margin="-4px 0 0 0">
      ...
      {emoji ? (
        <Box>
          <Icon>
            <Img
              ...
              src="https://ifh.cc/g/9soljs.png"
            />
            <Img
              style={{ marginTop: "24px" }}
              src="https://ifh.cc/g/NbRrk0.png"
              onClick={change}
            />
          </Icon>
          <RightBox>
            <EvaluationBox>“진행한 코스가 만족스러웠어요!”</EvaluationBox>
            <EvaluationBox>“사람들을 잘 이끌어줬어요!“</EvaluationBox>
            <EvaluationBox>“궁금한 점에 대해 빠르게 답해줬어요!”</EvaluationBox>
          </RightBox>
          <LeftBox>
            <EvaluationBox>
              “짐을 보관해줘서 편한 러닝이 가능했어요!”
            </EvaluationBox>
            <EvaluationBox>“시간 약속을 잘 지켰어요!”</EvaluationBox>
          </LeftBox>
          <EvaluationPoint>
            {profile_list?.evaluation?.evaluationCategory1}
            <br />
        ...
        <Box>
          <Icon>
            <Img
              style={{ marginTop: "30px" }}
              src="https://ifh.cc/g/Za01L3.png"
              onClick={change}
            />
            <Img
              style={{ marginTop: "24px" }}
              src="https://ifh.cc/g/byFtmr.png"
            />
          </Icon>
          {userId === myId ? (
            <>
              <RightBox>
                <EvaluationBox>“진행한 코스가 아쉬웠어요.”</EvaluationBox>
                <EvaluationBox>“크루원에게 불친절했어요.“</EvaluationBox>
                <EvaluationBox>“응답이 늦었어요.”</EvaluationBox>
              </RightBox>
              <LeftBox>
                <EvaluationBox>“변경사항을 안내해주지 않았어요.”</EvaluationBox>
                <EvaluationBox>“시간 약속을 잘 안지켰어요.”</EvaluationBox>
              </LeftBox>
              <EvaluationPoint>
            ...
            <Text size="20px" color="#7b7b7b" margin="-80px 0 0 500px">
              “아쉬웠어요.” 는 본인에게만 보여요!
            </Text>
          )}
        </Box>
